...
# date: 02 Apr 2025
# preamble: clean data analysis and preprocessesing for KMeans modelling
#
#         Since k-means is a distance based algorithm, we have to ensure that 
#         all numerical variable are scaled.
#
# pre-req: data preprocessing considerations; basic pandas manipulations
#
# additional notes: rmf.csv produced from this script is used in 
