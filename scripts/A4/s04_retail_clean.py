...
#
#         We can safely drop 1A, 1C, and 1D since they account for less than a 
...
#         representative of missing values compared to overall sample. 
#
# pre-req: data cleaning considerations; basic pandas manipulations
#
# additional notes: retail_analysis.csv produced from this script is used in 
