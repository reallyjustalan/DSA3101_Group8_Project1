...
models = ["XGBoost", "Gradient Boosting", "Random Forest", "SVR (RBF)", "MLP"]
...
# commented out code is to test to see if models are able to load in correctly. Use this 
# if not running on streamlit
"""
